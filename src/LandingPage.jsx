...
.ihms-lp .demo-cta-row{display:flex;gap:10px;margin-bottom:12px;flex-wrap:wrap}
.ihms-lp .demo-cta-row .btn{flex:1;min-width:150px;padding:11px 16px;font-size:13.5px}
          ...
          <div className="hero-grid">
            ...
            <div className="hero-visual" data-rv>
              <div className="demo-cta-row">
                ...
                <button
                  type="button"
                  className={"btn btn-ghost" + (demoCopied ? " copied" : "")}
                  title={demoCopied ? x.demoCopiedTitle : x.demoCopyTitle}
                  onClick={copyDemoLink}
                >
                  {demoCopied ? <Check size={16} /> : <Copy size={16} />} {demoCopied ? x.demoCopiedTitle : x.demoShareBtn}
                </button>
              </div>
