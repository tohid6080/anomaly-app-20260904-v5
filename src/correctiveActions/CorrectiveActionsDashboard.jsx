...
import { loadTripodCorrectiveActionsForCompany } from "../tripodBeta/tripodAnalysesApi.js";
...
// جداگانه‌ی tripod_corrective_actions ذخیره می‌شوند (مدیریت و ویرایش‌شان
// همچنان فقط از همان ماژول است) — اینجا فقط برای «هم‌دیده‌شدن» در همین
// لیست، به همان شکل ردیف‌های corrective_actions نگاشت می‌شوند و با
// __tripodOrigin به‌عنوان فقط‌خواندنی علامت‌گذاری می‌شوند.
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
      ...
      {filtered.map((a) => (
        <div
          key={a.id}
          style={{ ...styles.card, width: "auto", marginBottom: 8, cursor: a.__tripodOrigin ? "default" : "pointer" }}
          onClick={() => { if (!a.__tripodOrigin) openEdit(a); }}
        >
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              ...
              {a.__tripodOrigin ? (
                <div style={{ fontSize: 10.5, color: THEME.text3, marginTop: 3 }}>
                  ثبت و پیگیری این اقدام فقط از ماژول «مدیریت حوادث ← Tripod Beta» امکان‌پذیر است.
                </div>
              ) : (
                <div style={{ fontSize: 10.5, color: THEME.text3, marginTop: 3 }}>
