...
export const translations = {
  ...
  welcomeGreeting: { fa: "خوش آمدید", en: "Welcome" },
  welcomeSubtitle: { fa: "از منوی سمت راست، ماژول مورد نظر خود را انتخاب کنید.", en: "Select a module from the sidebar to get started." },
  ...
  moduleAnomalyReport: { fa: "مدیریت عدم انطباق‌ها", en: "Non-Conformance Management (Anomaly Report)" },
  subAnomalyForm: { fa: "ثبت آنومالی", en: "Report Anomaly" },
  subAnomalyList: { fa: "لیست آنومالی‌ها", en: "Anomaly List" },
  subCorrectiveActionsList: { fa: "لیست اقدامات اصلاحی", en: "Corrective Actions List" },
  moduleRiskAssessment: { fa: "مدیریت ارزیابی ریسک", en: "Risk Assessment Management" },
  ...
  moduleProactiveIndicators: { fa: "اندازه‌گیری شاخص‌های Proactive HSE", en: "Proactive HSE Indicators" },
  moduleIncidentManagement: { fa: "مدیریت حوادث", en: "Incident Management" },
