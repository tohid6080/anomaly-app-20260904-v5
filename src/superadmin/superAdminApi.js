...
export const SUBSCRIPTION_STATUSES = [
  ...
  { value: "expired", labelKey: "subStatusExpired", color: THEME.danger, bg: THEME.dangerBg },
  { value: "disabled", labelKey: "commonInactive", color: THEME.text3, bg: THEME.surface2 },
];
...
export function computePaymentStatus(finalAmount, payments) {
  ...
  if (totalPaid === 0) return { status: "unpaid", labelKey: "payStatusUnpaid", color: THEME.text3, bg: THEME.surface2, remaining, totalPaid };
...
// درختِ ماژول/زیرماژولِ پلن‌ها به ماژولِ سبکِ planFeatureCatalog.js منتقل شد تا
// صفحه‌ی خریدِ مشتری هم بدونِ کشیدنِ کلِ این فایل بتواند از آن استفاده کند.
// این re-export برای این است که همه‌ی واردکننده‌های قبلی دست‌نخورده بمانند.
export { PLAN_FEATURES } from "../planFeatureCatalog.js";
