...
// موتورِ پاسخ‌دهیِ مبتنی بر قوانینِ محلی (نه هوش مصنوعیِ واقعی): نگاشتِ
// کلیدواژه در سؤالِ کاربر → موضوعِ مرتبط. افزودنِ قانونِ جدید یعنی یک
// سطرِ دیگر به این آرایه.
const RULES = [
